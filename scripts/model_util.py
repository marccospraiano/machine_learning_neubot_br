...
def get_arguments():
    try:
        ...
        parser.add_argument('--horizon', type=int, default=22, help='Horizon width')
        ...
        parser.add_argument('--epochs', type=int, default=60, help='Number of epochs to run for training. Default=100')
